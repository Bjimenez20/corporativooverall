...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($query) {
        ...
        $subject = "Requerimiento de servicios de Outsourcing";
        $mail->addAddress('cdiazg@overall.com.pe');
                                    ...
                                    <td>
                                        ...
                                        <div style="line-height: 150%;">
                                            <div style="padding: 60px 50px;">
                                                <p style="margin: 20px 0;">Estimado equipo,</p>
                                                <p style="margin: 20px 0;">
                                                    Me gustaría conocer las soluciones de outsourcing de talento que manejan, particularmente para proyectos operativos o de alta rotación.
                                                </p>
                                                <p style="margin: 20px 0;">
                                                   Agradezco su orientación y disponibilidad.
                                                </p>
                                                <p style="margin: 20px 0;">
                                                    Saludos,
                                                </p>
