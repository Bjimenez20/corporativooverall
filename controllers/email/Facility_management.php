...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($query) {
        ...
        $subject = "Consulta sobre Facility Management";
                                        ...
                                        <div style="line-height: 150%;">
                                            <div style="padding: 60px 50px;">
                                                ...
                                                <p style="margin: 20px 0;">
                                                   Estoy interesado(a) en servicios integrales para la gestión de infraestructura y servicios generales. Me gustaría conocer su propuesta de valor.
                                                </p>
                                                <p style="margin: 20px 0;">
                                                    Cordialmente,
                                                </p>
